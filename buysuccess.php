...
<br><br>
<div>
        <center><p style="color:yellow;font-size:1.5rem;">Thank you for your order. Your order no. is <?php echo $_REQUEST['order_no'] ?></p></center>
    </div>
    ...
    while($res = mysqli_fetch_array($pro)){
        ...
        echo 
               " <div class='piza-list'>
                ...
                <center><a href='order.php?buy=$pro_id'>Add to cart</a></center>
                </div>"
        ;
    }
?>
